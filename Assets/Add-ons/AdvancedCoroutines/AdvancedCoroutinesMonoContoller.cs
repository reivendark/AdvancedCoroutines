...
namespace AdvancedCoroutines
{
    ...
    {
        private int _previousCamerasCount;
        ...
        private void Awake()
        {
            ...
            _previousCamerasCount = Camera.allCamerasCount;
            for (int i = 0; i < _previousCamerasCount; i++)
            {
        ...
        private void CheckCameras()
        {
            ...
            if (_previousCamerasCount != currentCamerasCount)
            {
                _previousCamerasCount = currentCamerasCount;
